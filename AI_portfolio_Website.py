...
with col2:
    st.image("chapter 04\images\Abubakar.jpg")
...
st.title('⚙️'"My Setup")
st.image("chapter 04\images\image.jpg")
...
with col1:
    st.image("chapter 04\images\g1.png")
    st.image("chapter 04\images\g2.png")
    st.image("chapter 04\images\g3.jpg")

with col2:
    st.image("chapter 04\images\g4 (2).jpg")
    st.image("chapter 04\images\g5.png")
    st.image("chapter 04\images\g6.jpg")

with col3:
    st.image("chapter 04\images\g7.jpg")
    st.image("chapter 04\images\g8.jpg")
    st.image("chapter 04\images\g9.jpg")

st.title('🌐'"CONTACT")
st.write("")
st.subheader("Get in touch with me if you have any queries")
